...
class ChallengeManager(private val settingsRepository: SettingsRepository) {
    ...
    private val vocabList = listOf(
        // --- NEW VOCAB QUESTIONS ---
        WordQ("What letter comes after H?", "I", listOf("It grows longer", "20", "Mount Everest"), 4),
        WordQ("What’s the opposite of “up”?", "Down", listOf("Friday", "Neil Armstrong", "Six"), 4),
        ...
        // --- NEW VOCAB QUESTIONS (Ages 3-4) ---
        WordQ("What is the opposite of 'In'?", "Out", listOf("Up", "Down", "Over"), 3),
        WordQ("What is the opposite of 'Yes'?", "No", listOf("Maybe", "Always", "Never"), 3),
        WordQ("What is the opposite of 'Day'?", "Night", listOf("Morning", "Sun", "Sky"), 3),
        WordQ("What does a cat say?", "Meow", listOf("Woof", "Moo", "Baa"), 3),
        WordQ("What does a dog say?", "Woof", listOf("Meow", "Oink", "Quack"), 3),
        WordQ("What does a cow say?", "Moo", listOf("Baa", "Cluck", "Ribbit"), 3),
        WordQ("What does a duck say?", "Quack", listOf("Moo", "Meow", "Woof"), 3),
        WordQ("What does a pig say?", "Oink", listOf("Baa", "Cluck", "Moo"), 3),
        WordQ("Spell the color: B_ue", "Blue", listOf("Bleu", "Bloo", "Bluu"), 4),
        WordQ("Spell the color: P_nk", "Pink", listOf("Pank", "Penk", "Ponk"), 4),
        WordQ("What is the opposite of 'Boy'?", "Girl", listOf("Man", "Woman", "Child"), 4),
        WordQ("What is the opposite of 'Good'?", "Bad", listOf("Nice", "Happy", "Sad"), 4),
        
        // --- NEW VOCAB QUESTIONS (Ages 5-6) ---
        WordQ("What is the opposite of 'Clean'?", "Dirty", listOf("Neat", "Tidy", "Washed"), 5),
        WordQ("What is the opposite of 'Light'?", "Dark", listOf("Day", "Sun", "Bright"), 5),
        WordQ("What is the opposite of 'Happy'?", "Sad", listOf("Joy", "Glad", "Mad"), 5),
        WordQ("What is the opposite of 'Short'?", "Tall", listOf("Small", "Little", "Tiny"), 5),
        WordQ("What is the opposite of 'Loud'?", "Quiet", listOf("Noisy", "Yelling", "Sound"), 5),
        WordQ("Spell the animal: D_g", "Dog", listOf("Dag", "Dig", "Dug"), 5),
        WordQ("Spell the animal: P_g", "Pig", listOf("Pag", "Peg", "Pug"), 5),
        WordQ("Spell the animal: B_ar", "Bear", listOf("Beer", "Bair", "Bare"), 5),
        WordQ("Spell the number: On_", "One", listOf("Won", "Oen", "Oon"), 5),
        WordQ("What is a synonym for 'Glad'?", "Happy", listOf("Sad", "Angry", "Mad"), 5),
        WordQ("What is a synonym for 'Small'?", "Little", listOf("Big", "Tall", "Huge"), 5),
        WordQ("What is a synonym for 'Quick'?", "Fast", listOf("Slow", "Lazy", "Stop"), 6),
        WordQ("What is the opposite of 'Left'?", "Right", listOf("Up", "Down", "Over"), 6),
        WordQ("What is the opposite of 'Hard'?", "Soft", listOf("Rock", "Solid", "Tough"), 6),
        WordQ("What is the opposite of 'Wet'?", "Dry", listOf("Water", "Rain", "Damp"), 6),
        WordQ("What is the opposite of 'Stop'?", "Go", listOf("Halt", "Wait", "Pause"), 6),
        
        // --- NEW VOCAB QUESTIONS (Ages 7-8) ---
        WordQ("What is a synonym for 'Scream'?", "Yell", listOf("Whisper", "Talk", "Sing"), 7),
        WordQ("What is a synonym for 'Silent'?", "Quiet", listOf("Noisy", "Loud", "Chatter"), 7),
        WordQ("What is a synonym for 'Jump'?", "Leap", listOf("Walk", "Run", "Crawl"), 7),
        WordQ("What is a synonym for 'Tired'?", "Sleepy", listOf("Awake", "Energetic", "Active"), 7),
        WordQ("What is a synonym for 'Wealthy'?", "Rich", listOf("Poor", "Broke", "Needy"), 7),
        WordQ("What is the opposite of 'Heavy'?", "Light", listOf("Dark", "Weight", "Big"), 7),
        WordQ("What is the opposite of 'Empty'?", "Full", listOf("Blank", "Hollow", "Clear"), 7),
        WordQ("What is the opposite of 'Brave'?", "Scared", listOf("Fearless", "Bold", "Hero"), 7),
        WordQ("What is the opposite of 'Cheap'?", "Expensive", listOf("Free", "Sale", "Discount"), 7),
        WordQ("Spell correctly:", "Because", listOf("Becaus", "Becuse", "Beacause"), 7),
        WordQ("Spell correctly:", "Friend", listOf("Freind", "Frend", "Friind"), 7),
        WordQ("Spell correctly:", "School", listOf("Skool", "Sckool", "Schul"), 7),
        WordQ("Spell correctly:", "People", listOf("Peeple", "Peopl", "Poepl"), 7),
        WordQ("What is a synonym for 'Tardy'?", "Late", listOf("Early", "On-time", "Prompt"), 8),
        WordQ("What is a synonym for 'Aid'?", "Help", listOf("Hinder", "Stop", "Ignore"), 8),
        WordQ("What is a synonym for 'Chilly'?", "Cold", listOf("Hot", "Warm", "Boiling"), 8),
        WordQ("What is a synonym for 'Yell'?", "Shout", listOf("Whisper", "Mumble", "Hum"), 8),
        WordQ("What is the opposite of 'Narrow'?", "Wide", listOf("Thin", "Slim", "Small"), 8),
        WordQ("What is the opposite of 'Rough'?", "Smooth", listOf("Bumpy", "Jagged", "Hard"), 8),
        WordQ("What is the opposite of 'Polite'?", "Rude", listOf("Nice", "Kind", "Sweet"), 8),
        WordQ("What is the opposite of 'Arrival'?", "Departure", listOf("Entrance", "Coming", "Greeting"), 8),
        WordQ("Spell correctly:", "Animal", listOf("Animel", "Anamal", "Amminal"), 8),
        WordQ("Spell correctly:", "Favorite", listOf("Favourit", "Favorit", "Faverite"), 8),
        WordQ("Spell correctly:", "Usually", listOf("Usualy", "Usally", "Ussually"), 8),
        
        // --- NEW VOCAB QUESTIONS (Ages 9-10) ---
        WordQ("What is a synonym for 'Abundant'?", "Plentiful", listOf("Scare", "Rare", "Empty"), 9),
        WordQ("What is a synonym for 'Determine'?", "Decide", listOf("Guess", "Wonder", "Think"), 9),
        WordQ("What is a synonym for 'Essential'?", "Necessary", listOf("Optional", "Extra", "Useless"), 9),
        WordQ("What is a synonym for 'Luminous'?", "Bright", listOf("Dark", "Dull", "Dim"), 9),
        WordQ("What is a synonym for 'Observe'?", "Watch", listOf("Ignore", "Miss", "Forget"), 9),
        WordQ("What is the opposite of 'Expand'?", "Shrink", listOf("Grow", "Enlarge", "Stretch"), 9),
        WordQ("What is the opposite of 'Fictional'?", "Real", listOf("Fake", "Story", "Myth"), 9),
        WordQ("What is the opposite of 'Include'?", "Exclude", listOf("Add", "Join", "Keep"), 9),
        WordQ("What is the opposite of 'Temporary'?", "Permanent", listOf("Short", "Brief", "Passing"), 9),
        WordQ("Spell correctly:", "Wednesday", listOf("Wensday", "Wednesdey", "Whensday"), 9),
        WordQ("Spell correctly:", "Different", listOf("Diferent", "Diffrent", "Differant"), 9),
        WordQ("Spell correctly:", "Excellent", listOf("Exelent", "Excellant", "Excelent"), 9),
        WordQ("Spell correctly:", "Knowledge", listOf("Nowledge", "Knowlege", "Knoledge"), 9),
        WordQ("Spell correctly:", "Surprise", listOf("Suprise", "Surprize", "Suprize"), 9),
        WordQ("Spell correctly:", "Tomorrow", listOf("Tommorrow", "Tomorow", "To-morrow"), 9),
        
        WordQ("What is a synonym for 'Magnificent'?", "Splendid", listOf("Awful", "Terrible", "Boring"), 10),
        WordQ("What is a synonym for 'Vast'?", "Huge", listOf("Tiny", "Small", "Miniature"), 10),
        WordQ("What is a synonym for 'Inevitable'?", "Unavoidable", listOf("Uncertain", "Unlikely", "Doubtful"), 10),
        WordQ("What is a synonym for 'Courageous'?", "Brave", listOf("Cowardly", "Timid", "Fearful"), 10),
        WordQ("What is the opposite of 'Transparent'?", "Opaque", listOf("Clear", "See-through", "Glass"), 10),
        WordQ("What is the opposite of 'Abundant'?", "Scarce", listOf("Many", "Plentiful", "Ample"), 10),
        WordQ("What is the opposite of 'Timid'?", "Bold", listOf("Shy", "Scared", "Nervous"), 10),
        WordQ("What is the opposite of 'Conceal'?", "Reveal", listOf("Hide", "Cover", "Bury"), 10),
        WordQ("Spell correctly:", "Environment", listOf("Enviroment", "Environmant", "Enviornment"), 10),
        WordQ("Spell correctly:", "Definitely", listOf("Definately", "Definitly", "Definitally"), 10),
        WordQ("Spell correctly:", "Restaurant", listOf("Restarant", "Restuarant", "Resteraunt"), 10),
        WordQ("Spell correctly:", "Receive", listOf("Recieve", "Receve", "Reseive"), 10),
        WordQ("Spell correctly:", "Believe", listOf("Beleive", "Belive", "Beleave"), 10)
    ...
    private val gkList = listOf(
        // --- NEW GK QUESTIONS ---
        WordQ("What sound does a cow make?", "Moo", listOf("Porridge", "The Milky Way", "A cow"), 4),
        WordQ("Which animal has a long trunk?", "Elephant", listOf("Bamboo", "Cat", "Blue"), 4),
        WordQ("What animal says \"meow\"?", "Cat", listOf("The Milky Way", "Rapunzel", "The heart"), 4),
        WordQ("Which animal is known for hopping?", "Kangaroo", listOf("An ogre", "The Sahara", "A star"), 4),
        WordQ("What pet purrs when it's happy?", "Cat", listOf("A telescope", "A coat", "A swan"), 4),
        WordQ("What colour is a duck's beak?", "Orange", listOf("Friday", "Shoes", "Moo"), 4),
        WordQ("What animal is black and white and eats bamboo?", "Panda", listOf("Seeds", "Shoes", "Steam"), 4),
        WordQ("Which bird can talk?", "Parrot", listOf("Winter", "Pound sterling", "1912"), 4),
        WordQ("What is a baby dog called?", "Puppy", listOf("Fat", "Rumpelstiltskin", "Read books"), 4),
        WordQ("Which sea creature has eight legs?", "Octopus", listOf("Breadcrumbs", "Pinocchio", "Little Red Riding Hood"), 4),
        WordQ("What colour is the sky on a sunny day?", "Blue", listOf("Little Red Riding Hood", "Elephant", "Eight"), 4),
        WordQ("What colour are bananas?", "Yellow", listOf("Spoon", "Little Red Riding Hood", "Snail"), 4),
        WordQ("What shape has three sides?", "Triangle", listOf("It grows longer", "Tadpoles", "France"), 4),
        WordQ("What colour is grass?", "Green", listOf("Honey", "A teacher", "Circle"), 4),
        WordQ("What shape is a football?", "Circle", listOf("Oxygen", "Mercury", "Eight"), 4),
        WordQ("What shape has four equal sides?", "Square", listOf("Triangle", "Little Red Riding Hood", "Roald Dahl"), 4),
        WordQ("What colour is a stop sign?", "Red", listOf("Greg Heffley", "George Washington", "Alice"), 4),
        WordQ("What colour do you get when you mix red and yellow?", "Orange", listOf("Moo", "Red", "Jupiter"), 4),
        WordQ("What shape is a penny?", "Round", listOf("Friday", "Alice", "Giraffe"), 4),
        WordQ("What is the colour of snow?", "White", listOf("Kitten", "1912", "Peter Pan"), 4),
        WordQ("What food do bees make?", "Honey", listOf("Mount Everest", "206", "Charlie Bucket"), 5),
        WordQ("What do you use to brush your teeth?", "Toothbrush", listOf("Giraffe", "Triangle", "Milk"), 5),
        WordQ("What do you wear on your feet?", "Shoes", listOf("Cat", "Steve", "Down"), 5),
        WordQ("What do you add to cereal?", "Milk", listOf("A telescope", "Orange", "Pizza"), 5),
        WordQ("What do you use to eat soup?", "Spoon", listOf("The Sahara", "Narnia", "Zebra"), 5),
        WordQ("What food is round and comes with cheese and tomato?", "Pizza", listOf("Gravity", "Rome", "A marker"), 5),
        WordQ("What fruit is red and has seeds on the outside?", "Strawberry", listOf("Mars", "Breadcrumbs", "A star"), 5),
        WordQ("What do you put on toast?", "Butter or Jam", listOf("Winter", "Roald Dahl", "Giraffe"), 5),
        WordQ("What comes out of a kettle?", "Steam", listOf("A beanstalk", "0°C", "Scissors"), 5),
        WordQ("What do you use to cut paper?", "Scissors", listOf("The heart", "Ruby slippers", "A telescope"), 5),
        WordQ("Who had very long hair and was locked in a tower?", "Rapunzel", listOf("Ice", "Puppy", "An ogre"), 6),
        WordQ("What is the name of the wooden puppet who wanted to be a real boy?", "Pinocchio", listOf("Orange", "Steam", "Strawberry"), 6),
        WordQ("What does Cinderella ride to the ball?", "A pumpkin carriage", listOf("Vertebrates", "Down", "Square"), 6),
        WordQ("Who is the girl who visits a house of three bears?", "Goldilocks", listOf("Ruby slippers", "Gravity", "The Sahara"), 6),
        WordQ("What did the Big Bad Wolf say he would do to the little pigs’ houses?", "\"I'll huff and I'll puff and I'll blow your house down!\"", listOf("A pumpkin carriage", "It grows longer", "Black and white"), 6),
        WordQ("In Jack and the Beanstalk, what does Jack trade for magic beans?", "A cow", listOf("Their leaves", "Narnia", "Pound sterling"), 6),
        WordQ("What kind of shoes did the Wicked Witch of the East wear in The Wizard of Oz?", "Ruby slippers", listOf("Mercury", "Winnie the Pooh", "Hadrian’s Wall"), 6),
        WordQ("What does Pinocchio’s nose do when he tells a lie?", "It grows longer", listOf("Winter", "Peter Pan", "A pride"), 6),
        WordQ("Who lives in a house made of gingerbread?", "The witch from Hansel and Gretel", listOf("A rainbow", "A spacesuit", "A piano"), 6),
        WordQ("In Beauty and the Beast, what does Belle love to do?", "Read books", listOf("Goldilocks", "Winnie the Pooh", "Stork"), 6),
        WordQ("Which animal is the tallest in the world?", "Giraffe", listOf("Their leaves", "Winter", "Strawberry"), 4),
        WordQ("What do pandas mostly eat?", "Bamboo", listOf("Butter or Jam", "The heart", "Ice"), 4),
        WordQ("What animal lives in a shell and moves slowly?", "Snail", listOf("It grows longer", "Round", "Tadpoles"), 4),
        WordQ("Which sea animal has five arms?", "Starfish", listOf("Six", "Read books", "Mount Everest"), 4),
        WordQ("What do you call a baby cat?", "Kitten", listOf("Cinderella", "The Milky Way", "Pinocchio"), 4),
        WordQ("What do frogs start life as?", "Tadpoles", listOf("Percy Jackson", "The Milky Way", "Orange"), 4),
        WordQ("Which bird delivers babies in fairy tales?", "Stork", listOf("Blue", "Mount Everest", "Vertebrates"), 4),
        WordQ("What do you call a group of lions?", "A pride", listOf("A rainbow", "Starfish", "A beanstalk"), 4),
        WordQ("What do camels store in their humps?", "Fat", listOf("Kangaroo", "Goldilocks", "0°C"), 4),
        WordQ("Which animal is famous for its black and white stripes?", "Zebra", listOf("Moo", "Rumpelstiltskin", "Saturn"), 4),
        WordQ("What number comes after 19?", "20", listOf("Fat", "Winnie the Pooh", "Elephant"), 4),
        WordQ("What do you call the person who teaches you?", "A teacher", listOf("George Washington", "Fat", "Avocado"), 4),
        WordQ("How many legs does a spider have?", "Eight", listOf("Giraffe", "Greg Heffley", "Shoes"), 4),
        WordQ("What do you use to write on a whiteboard?", "A marker", listOf("Rome", "Seeds", "Saturn"), 4),
        WordQ("What’s 10 minus 3?", "7", listOf("Milk", "Cat", "Rapunzel"), 4),
        WordQ("What is the colour of the school crossing sign in the UK?", "Red and white", listOf("Pizza", "Europe", "J.K. Rowling"), 4),
        WordQ("Which day comes after Thursday?", "Friday", listOf("Moo", "Scissors", "Cat"), 4),
        WordQ("What is the first month of the year?", "January", listOf("Starfish", "Orange", "Strawberry"), 4),
        WordQ("What do you use when it rains?", "Umbrella", listOf("Water", "Cat", "Breadcrumbs"), 4),
        WordQ("What is frozen water called?", "Ice", listOf("Rumpelstiltskin", "January", "A pride"), 4),
        WordQ("What colour are leaves in spring?", "Green", listOf("Avocado", "I", "A pumpkin carriage"), 4),
        WordQ("What does the sun give us?", "Light and warmth", listOf("January", "Pound sterling", "Night"), 4),
        WordQ("What do we wear when it’s cold?", "A coat", listOf("Red and white", "Mars", "Strawberry"), 4),
        WordQ("What do you see in the sky if it's sunny after it rains?", "A rainbow", listOf("Triangle", "Pacific Ocean", "Read books"), 4),
        WordQ("What season comes after autumn?", "Winter", listOf("Friday", "7", "Puppy"), 4),
        WordQ("What do flowers grow from?", "Seeds", listOf("Peter Pan", "Saturn", "Cavemen or Stone Age people"), 4),
        WordQ("What do you call water that falls from the sky?", "Rain", listOf("Water", "Snail", "A cow"), 4),
        WordQ("What do trees lose in the autumn?", "Their leaves", listOf("Mount Everest", "Cat", "Vertebrates"), 4),
        WordQ("Who wore a red cloak and visited her granny?", "Little Red Riding Hood", listOf("Triangle", "Starfish", "The witch from Hansel and Gretel"), 4),
        WordQ("Who left a glass slipper behind at a ball?", "Cinderella", listOf("Cat", "Seeds", "The Milky Way"), 4),
        WordQ("What did Jack climb in the story “Jack and the Beanstalk”?", "A beanstalk", listOf("The witch from Hansel and Gretel", "Alice", "Pacific Ocean"), 4),
        WordQ("What kind of creature is Shrek?", "An ogre", listOf("Round", "Mercury", "Their leaves"), 4),
        WordQ("Who spun straw into gold?", "Rumpelstiltskin", listOf("Steve", "Blue", "Moo"), 4),
        WordQ("What animal tricked the gingerbread man?", "A fox", listOf("Tadpoles", "Cat", "Parrot"), 4),
        WordQ("What did the three bears eat in their house?", "Porridge", listOf("Roald Dahl", "Pizza", "A pride"), 4),
        WordQ("What did the ugly duckling turn into?", "A swan", listOf("Circle", "Little Red Riding Hood", "Honey"), 4),
        WordQ("Who had a glass slipper?", "Cinderella", listOf("Steam", "Butter or Jam", "Snail"), 4),
        WordQ("What did Hansel and Gretel drop to find their way home?", "Breadcrumbs", listOf("A marker", "Bamboo", "A coat"), 4),
        WordQ("What is the capital city of Italy?", "Rome", listOf("Triangle", "Strawberry", "Porridge"), 10),
        WordQ("What is the tallest mountain in the world?", "Mount Everest", listOf("Canberra", "Cinderella", "Spoon"), 10),
        WordQ("Which ocean is the largest?", "Pacific Ocean", listOf("Ruby slippers", "20", "Rain"), 10),
        WordQ("How many sides does a hexagon have?", "Six", listOf("Seeds", "The Milky Way", "20"), 10),
        WordQ("What is the main ingredient in guacamole?", "Avocado", listOf("Rain", "Shoes", "Tadpoles"), 10),
        WordQ("What’s the currency of the UK?", "Pound sterling", listOf("A piano", "George Washington", "Tadpoles"), 10),
        WordQ("Which two colours make purple?", "Red and blue", listOf("A marker", "Pinocchio", "Square"), 10),
        WordQ("What instrument has 88 keys?", "A piano", listOf("Eight", "206", "Tadpoles"), 10),
        WordQ("How many bones are in the adult human body?", "206", listOf("Cat", "Ice", "Little Red Riding Hood"), 10),
        WordQ("What is the name of the hero in the game Minecraft?", "Steve", listOf("A coat", "Mount Everest", "Canberra"), 10),
        WordQ("What gas do humans breathe in from the air?", "Oxygen", listOf("The heart", "Rapunzel", "A pumpkin carriage"), 10),
        WordQ("What planet is known as the Red Planet?", "Mars", listOf("George Washington", "Steve", "Cavemen or Stone Age people"), 10),
        WordQ("What part of your body pumps blood?", "The heart", listOf("Starfish", "Green", "Avocado"), 10),
        WordQ("What do bees collect from flowers?", "Nectar", listOf("Europe", "Greg Heffley", "Lungs"), 10),
        WordQ("What is H2O more commonly known as?", "Water", listOf("Eight", "Fat", "A pride"), 10),
        WordQ("What natural force keeps us on the ground?", "Gravity", listOf("Eight", "A fox", "Europe"), 10),
        WordQ("What are animals with a backbone called?", "Vertebrates", listOf("1912", "Red and blue", "A spacesuit"), 10),
        WordQ("Which organ helps you breathe?", "Lungs", listOf("Charlie Bucket", "Shoes", "A swan"), 10),
        WordQ("What is the freezing point of water?", "0°C", listOf("Light and warmth", "Triangle", "Herbivores"), 10),
        WordQ("What’s the name for animals that only eat plants?", "Herbivores", listOf("Canberra", "Yellow", "Porridge"), 10),
        WordQ("What is the name of Earth’s galaxy?", "The Milky Way", listOf("0°C", "Kangaroo", "Green"), 10),
        WordQ("What is the closest planet to the Sun?", "Mercury", listOf("Ruby slippers", "Their leaves", "Steve"), 10),
        WordQ("How many planets are in our solar system?", "Eight", listOf("France", "Green", "Vertebrates"), 10),
        WordQ("What planet has rings around it?", "Saturn", listOf("A star", "Little Red Riding Hood", "Parrot"), 10),
        WordQ("What’s the name of the first person to walk on the Moon?", "Neil Armstrong", listOf("Milk", "Oxygen", "Red and blue"), 10),
        WordQ("Which planet is famous for its big red spot?", "Jupiter", listOf("Eight", "It grows longer", "Puppy"), 10),
        WordQ("What time of day is it when the Moon is out?", "Night", listOf("Nectar", "Strawberry", "Honey"), 10),
        WordQ("What do astronauts wear in space?", "A spacesuit", listOf("A rainbow", "Herbivores", "Puppy"), 10),
        WordQ("What is the Sun – a star, a planet or a moon?", "A star", listOf("1912", "A piano", "Strawberry"), 10),
        WordQ("What do we use to look at stars in the sky?", "A telescope", listOf("A cow", "A marker", "Winnie the Pooh"), 10),
        WordQ("Who wrote the Harry Potter series?", "J.K. Rowling", listOf("Honey", "Porridge", "Strawberry"), 10),
        WordQ("What’s the name of the boy who never grows up?", "Peter Pan", listOf("A pride", "Narnia", "Little Red Riding Hood"), 10),
        WordQ("In Roald Dahl’s story, who visits a chocolate factory?", "Charlie Bucket", listOf("Percy Jackson", "A swan", "Neil Armstrong"), 10),
        WordQ("Who is the bear who loves honey?", "Winnie the Pooh", listOf("Cinderella", "Eight", "Puppy"), 10),
        WordQ("What colour is the cat in The Cat in the Hat?", "Black and white", listOf("1912", "It grows longer", "Bamboo"), 10),
        WordQ("Who wrote Matilda?", "Roald Dahl", listOf("Light and warmth", "Orange", "The Sahara"), 10),
        WordQ("What’s the name of the girl who falls down a rabbit hole?", "Alice", listOf("Light and warmth", "A marker", "A swan"), 10),
        WordQ("Who is the Greek hero with a lightning bolt in a book series?", "Percy Jackson", listOf("Charlie Bucket", "Cavemen or Stone Age people", "Rain"), 10),
        WordQ("What’s the name of the diary-writing schoolboy created by Jeff Kinney?", "Greg Heffley", listOf("Green", "Moo", "Porridge"), 10),
        WordQ("In The Lion, the Witch and the Wardrobe, what magical land do the children enter?", "Narnia", listOf("Percy Jackson", "Lungs", "Night"), 10),
        WordQ("Who was the first President of the United States?", "George Washington", listOf("Neil Armstrong", "7", "Cat"), 10),
        WordQ("What year did the Titanic sink?", "1912", listOf("George Washington", "Puppy", "Mars"), 10),
        WordQ("What ancient wonder is found in Egypt?", "The Pyramids", listOf("Giraffe", "Percy Jackson", "Peter Pan"), 10),
        WordQ("What’s the name of the wall built by Romans in the UK?", "Hadrian’s Wall", listOf("Water", "Red", "The Milky Way"), 10),
        WordQ("Which country is home to the Great Wall?", "China", listOf("Rapunzel", "Mercury", "Alice"), 10),
        WordQ("What’s the capital of Australia?", "Canberra", listOf("A pride", "Night", "Ruby slippers"), 10),
        WordQ("In which country would you find the Eiffel Tower?", "France", listOf("7", "The heart", "A telescope"), 10),
        WordQ("What’s the name of the largest desert in the world?", "The Sahara", listOf("The Milky Way", "Orange", "7"), 10),
        WordQ("Which continent is the UK part of?", "Europe", listOf("White", "Kangaroo", "Starfish"), 10),
        WordQ("What do we call people who lived thousands of years ago and made tools from stone?", "Cavemen or Stone Age people", listOf("Nectar", "The Sahara", "Percy Jackson"), 10),
        WordQ("How many months do we have in a year?", "12 months", listOf("Dom Perignon", "Au", "Dictionary"), 5),
        WordQ("How many days do we have in a week?", "7 days", listOf("Mycology", "Nile", "Flower"), 5),
        WordQ("How many days are there in a year?", "365 days", listOf("Propane and Butane", "12", "23"), 5),
        WordQ("What is 2+2?", "4", listOf("5", "3", "6"), 5),
        WordQ("Which number comes after 6?", "7", listOf("8", "6", "9"), 5),
        WordQ("How many colors are there in a rainbow?", "7", listOf("8", "6", "9"), 5),
        WordQ("What are your ears for?", "Listening/hearing.", listOf("Longitudinal waves", "1914", "Wood"), 5),
        WordQ("Which day comes after Friday?", "Saturday", listOf("The Wright brothers", "One under par", "Seaweed"), 5),
        WordQ("We use our eyes to — see, hear, feel, eat?", "See", listOf("Bill Gates", "Triangle, square, hexagon, octagon", "Pineapple and Ham"), 5),
        WordQ("What type of insect do you see in this picture— bee, ant, butterfly, spider?", "Butterfly", listOf("Sock", "Brush", "Books"), 5),
        WordQ("What color is the sky on a clear day?", "Blue", listOf("Dom Perignon", "Paris", "Myology"), 5),
        WordQ("What item tells the time?", "A watch/clock", listOf("Giraffe", "Five", "Pineapple and Ham"), 5),
        WordQ("What holiday is Santa Claus associated with?", "Christmas", listOf("North Atlantic Ocean", "Resin", "Voltaire"), 5),
        WordQ("How many legs does a spider have?", "8", listOf("9", "7", "10"), 5),
        WordQ("What do you call a house made of ice?", "Igloo", listOf("Tadpole", "Voltaire", "Charles Robert Darwin"), 5),
        WordQ("How many seasons are there?", "4", listOf("5", "3", "6"), 5),
        WordQ("What are the four seasons?", "Spring, Summer, Autumn, and Winter", listOf("Milky Way", "Dictionary", "Giraffe"), 5),
        WordQ("What do you call a place where you borrow books from?", "Library", listOf("Crust", "False (originally from West Africa)", "Photograph"), 5),
        WordQ("What kind of animal is Simba in The Lion King?", "Lion", listOf("Mexico City", "12", "Christopher Columbus"), 5),
        WordQ("How many sides does a triangle have?", "3", listOf("4", "2", "5"), 5),
        WordQ("What shape is the letter O?", "Circle", listOf("Diamond", "Seven", "Igloo"), 5),
        WordQ("What do you use to cut paper?", "Scissors", listOf("4", "Tomato", "Pacific Ocean"), 5),
        WordQ("What is the color of an unripe tomato?", "Green", listOf("Mycology", "Christopher Columbus", "21"), 5),
        WordQ("What is a baby frog called?", "Tadpole", listOf("Flower", "Anemometer", "7 days"), 6),
        WordQ("Where does a pig live?", "Sty", listOf("Alexander Graham Bell", "Katherine Hepburn (4 Oscars and 12 nominations)", "False (originally from West Africa)"), 6),
        WordQ("Which animal is known as the ‘Ship of the Desert?’", "Camel", listOf("Switzerland", "Vatican City", "Alexander Graham Bell"), 6),
        WordQ("How many letters are there in the English alphabet?", "26", listOf("27", "25", "28"), 6),
        WordQ("What do you call the person who brings a letter to your home from the post office?", "Postman", listOf("7 days", "Pacific", "Italy"), 6),
        WordQ("How do you relate to your maternal grandfather?", "Mother’s father", listOf("4", "Postman", "Coal"), 6),
        WordQ("We smell with our _______", "Nose", listOf("Africa", "William Shakespeare", "3"), 6),
        WordQ("Baby of a dog is called__________", "Puppy", listOf("Igloo", "Razor", "Propane and Butane"), 6),
        WordQ("How many flamingos do you see in the picture?", "12 flamingos", listOf("The Wright brothers", "Flower", "52"), 6),
        WordQ("What is this beautiful structure called?", "The Taj Mahal", listOf("June 5", "Table", "30"), 6),
        WordQ("What is a tool used to navigate directions called?", "Compass", listOf("Japan", "Fish", "Coal"), 6),
        WordQ("What is the largest planet in our solar system?", "Jupiter", listOf("East", "Lightbulb", "52"), 6),
        WordQ("What is the name of the world’s longest river?", "Nile", listOf("Doc, Grumpy, Happy, Sleepy, Dopey, Bashful and Sneezy.", "Giraffe", "Photosynthesis"), 6),
        WordQ("How many bones are there in the human body?", "206", listOf("207", "205", "208"), 6),
        WordQ("What is the hardest mineral in the world?", "Diamond", listOf("‘To be played softly.’", "Tulips", "False (originally from West Africa)"), 6),
        WordQ("What is the national bird of India?", "Peacock", listOf("The Taj Mahal", "Marathon", "11"), 6),
        WordQ("Which direction does the sun rise from?", "East", listOf("Jupiter", "Greenland shark", "Painter"), 6),
        WordQ("Where should we cross the road?", "Zebra crossing", listOf("Nose", "206", "Spring, Summer, Autumn, and Winter"), 6),
        WordQ("A shape with six sides is called?", "Hexagon", listOf("Higher", "Red, Blue, and Yellow", "False (originally from West Africa)"), 6),
        WordQ("What are the three primary colors?", "Red, Blue, and Yellow", listOf("Saint Valentine", "William Shakespeare", "Voltaire"), 6),
        WordQ("Which bird lays the largest eggs?", "Ostrich", listOf("Butterfly", "Giraffe", "Peacock"), 6),
        WordQ("Which ocean is the largest in the world?", "Pacific Ocean", listOf("Blue", "23", "Dom Perignon"), 6),
        WordQ("How many continents are there in the world?", "Seven", listOf("Harper Lee", "Milky Way", "Six"), 6),
        WordQ("Can you name the seven dwarfs of Snow White?", "Doc, Grumpy, Happy, Sleepy, Dopey, Bashful and Sneezy.", listOf("Pizza", "Scissors", "Sword"), 9),
        WordQ("Trout, carp and barracuda are names of what?", "Fish", listOf("23", "George Orwell", "Mexico City"), 9),
        WordQ("How many consonants are there in the English alphabet?", "21", listOf("22", "20", "23"), 9),
        WordQ("What grows quicker—hair or toenails?", "Hair", listOf("Greenland shark", "Postman", "Jupiter"), 9),
        WordQ("Which is the tallest mountain in the world?", "Mount Everest", listOf("Marathon", "Tomato", "Library"), 9),
        WordQ("Which Saint’s Day is celebrated on 14th February?", "Saint Valentine", listOf("Mycology", "Female", "Hexagon"), 9),
        WordQ("Which famous children’s book has two characters named Tweedledum and Tweedledee?", "Alice, Through the Looking-Glass by Lewis Carroll", listOf("Photosynthesis", "Doc, Grumpy, Happy, Sleepy, Dopey, Bashful and Sneezy.", "Diamond"), 9),
        WordQ("Which planet is known as the Red Planet?", "Mars", listOf("Painter", "Razor", "Peacock"), 9),
        WordQ("Place these shapes in order of how many sides they have—square, triangle, octagon, and hexagon?", "Triangle, square, hexagon, octagon", listOf("50 stars and 13 stripes", "Coal", "Wood"), 9),
        WordQ("Which of the following is not a metal: gold, resin, glass?", "Resin", listOf("Voltaire", "Bill Gates", "Tomato"), 9),
        WordQ("Which is the largest plateau in the world?", "Tibetan Plateau", listOf("Tibet", "Table", "Dom Perignon"), 9),
        WordQ("In which ocean did the famous Titanic sink in 1912— Pacific, North Atlantic, or the Mediterranean?", "North Atlantic Ocean", listOf("4", "June 5", "Alfred Nobel"), 9),
        WordQ("What is the next number in the following sequence– 7, 14, 21, 28?", "35", listOf("36", "34", "37"), 9),
        WordQ("Which two parts of the body continue to grow for your entire life?", "Nose and ears", listOf("Matthew", "Mars", "Soccer"), 9),
        WordQ("What makes up (approx.) 80% of our brain’s volume?", "Water", listOf("The Wright brothers", "Compass", "Tulips"), 9),
        WordQ("What is the largest flower in the world?", "Rafflesia", listOf("A dance workout", "World Wide Web", "Rug"), 9),
        WordQ("How many months of the year have 31 days?", "Seven", listOf("June 5", "O", "Zebra crossing"), 9),
        WordQ("Who wrote the renowned play ‘Romeo and Juliet’?", "William Shakespeare", listOf("See", "Photosynthesis", "Smartphone"), 9),
        WordQ("The process by which plants make their own food is called?", "Photosynthesis", listOf("50 stars and 13 stripes", "Palm", "Deccan"), 9),
        WordQ("Which country is called the ‘Sugar Bowl of the World?’", "Cuba", listOf("Water", "East", "Mercury"), 9),
        WordQ("Which country is known as the ‘Land of the Rising Sun?’", "Japan", listOf("11", "William Shakespeare", "Matthew"), 9),
        WordQ("Who painted ‘The Last Supper?’", "Leonardo da Vinci", listOf("Au", "Triangle, square, hexagon, octagon", "3"), 9),
        WordQ("What is the chemical symbol for water?", "H2O", listOf("12 flamingos", "Water", "False (originally from West Africa)"), 9),
        WordQ("Who invented the telephone?", "Alexander Graham Bell", listOf("Compass", "North Atlantic Ocean", "Rainfall"), 9),
        WordQ("Who invented the airplane?", "The Wright brothers", listOf("Seven", "Albert Einstein", "Zebra crossing"), 9),
        WordQ("What is the largest lizard on Earth?", "Komodo dragon", listOf("30", "Soccer", "Fish"), 9),
        WordQ("When is World Environment Day celebrated?", "June 5", listOf("4", "Speedometer", "Paprika"), 9),
        WordQ("Which place is known as the ‘Roof of the World?’", "Tibet", listOf("Radiation", "Laptop", "Jupiter"), 9),
        WordQ("Which country does volleyball originate from?", "The USA", listOf("Six", "88", "Roberto Baggio"), 10),
        WordQ("What is Zumba?", "A dance workout", listOf("Photograph", "East", "False (originally from West Africa)"), 10),
        WordQ("Is the temperature of the moon higher or lower during the day?", "Higher", listOf("Africa", "Zebra crossing", "Igloo"), 10),
        WordQ("Which planet is the smallest: Neptune, Mars, Mercury?", "Mercury", listOf("The Taj Mahal", "Hair", "Italy"), 10),
        WordQ("Your blood type is determined by the genes you inherit from your parents: True or False?", "True", listOf("False", "12 months", "Tulips"), 10),
        WordQ("What is the square root of 144?", "12", listOf("13", "11", "14"), 10),
        WordQ("What is three-fifths of 50?", "30", listOf("31", "29", "32"), 10),
        WordQ("During which year did World War I begin?", "1914", listOf("1915", "1913", "1916"), 10),
        WordQ("Which famous explorer discovered Cuba?", "Christopher Columbus", listOf("Scissors", "Lion", "50 stars and 13 stripes"), 10),
        WordQ("Who hunts most – male or female lion?", "Female", listOf("Italy", "The Wright brothers", "Television"), 10),
        WordQ("What type of whale is the biggest animal in the world?", "Blue Whale", listOf("Table", "Mercury", "Speedometer"), 10),
        WordQ("Who was nicknamed “Trey” (Three in card terminology), when he was young?", "Bill Gates", listOf("Rainfall", "Listening/hearing.", "Nose"), 10),
        WordQ("His tomb in France reads “He taught us how to become free” as his writings were instrumental in creating a spirit of freedom during the French Revolution. Who was he?", "Voltaire", listOf("Red, Blue, and Yellow", "Dom Perignon", "Seaweed"), 10),
        WordQ("The name ‘Teddy Bear’ is used to describe a soft, toy bear. The name comes from President Theodore ‘Teddy’ Roosevelt who once set a bear cub free: True or False", "True", listOf("False", "Christopher Columbus", "Hair"), 10),
        WordQ("Which first electrical item did Thomas Edison invent?", "Lightbulb", listOf("Pizza", "Hydrogen", "Sword"), 10),
        WordQ("What is the study of the structure, functions, disorders, and diseases of the muscular system called?", "Myology", listOf("Ostrich", "Japan", "Albert Einstein"), 10),
        WordQ("How long does humans take to digest the food?", "24 to 72 hours", listOf("Roberto Baggio", "Marathon", "7 days"), 10),
        WordQ("What is the smallest country in the world?", "Vatican City", listOf("June 5", "Nile", "Red, Blue, and Yellow"), 10),
        WordQ("Which element has the atomic number 1?", "Hydrogen", listOf("Camel", "Voltaire", "Doc, Grumpy, Happy, Sleepy, Dopey, Bashful and Sneezy."), 10),
        WordQ("How many layers does Earth’s atmosphere have?", "Five", listOf("Tulips", "Flower", "Butterfly"), 10),
        WordQ("Which country has more kangaroos than humans?", "Australia", listOf("Pineapple and Ham", "Alfred Nobel", "Soccer"), 10),
        WordQ("What is the largest organ in the human body?", "Skin", listOf("Resin", "Saint Valentine", "Laptop"), 10),
        WordQ("Which galaxy is the Earth a part of?", "Milky Way", listOf("The USA", "Paprika", "Palm"), 10),
        WordQ("Which animal has the longest life expectancy?", "Greenland shark", listOf("Nose and ears", "Christopher Columbus", "Giraffe"), 10),
        WordQ("Which mammal does not have vocal cords?", "Giraffe", listOf("Blue", "Christmas", "Resin"), 10),
        WordQ("How many US states have a coastline?", "23", listOf("24", "22", "25"), 10),
        WordQ("In which ocean is the Ring of Fire found?", "Pacific Ocean", listOf("Pacific", "Jupiter", "12 months"), 10),
        WordQ("Abraham Lincoln is the ___________ President of the US.", "16th", listOf("17", "15", "18"), 10),
        WordQ("How many players are there in an ice hockey team?", "Six", listOf("Tulips", "School", "Alexander Graham Bell"), 10),
        WordQ("LPG(Liquefied Petroleum Gas) is mainly a mixture of which gases?", "Propane and Butane", listOf("Lightbulb", "Smartphone", "Dom Perignon"), 10),
        WordQ("Which instrument is used for measuring wind speed?", "Anemometer", listOf("Australia", "206", "Myology"), 10),
        WordQ("How many straight edges does a cube have?", "12", listOf("13", "11", "14"), 10),
        WordQ("Which layer of planet Earth is made up of tectonic plates: Inner Core, Outer Core, Mantle, or Crust?", "Crust", listOf("Mars", "East", "365 days"), 10),
        WordQ("Convection, Frontal and Relief are the three main types of clouds, rainfall, or winds?", "Rainfall", listOf("June 5", "Brush", "30"), 10),
        WordQ("Can you name the legendary Benedictine monk who invented champagne?", "Dom Perignon", listOf("Hydrogen", "Triangle, square, hexagon, octagon", "Butterfly"), 10),
        WordQ("Which actress has won the most Oscars?", "Katherine Hepburn (4 Oscars and 12 nominations)", listOf("East", "52", "J.J. Thomson"), 10),
        WordQ("Which kind of ‘bulbs’ were once exchanged as a form of currency?", "Tulips", listOf("Palm", "Chocolate", "Christopher Columbus"), 10),
        WordQ("What does the term ‘Piano’ mean?", "‘To be played softly.’", listOf("Brush", "Propane and Butane", "11"), 10),
        WordQ("What does the term ‘birdie’ mean in a game of golf?", "One under par", listOf("Compass", "‘To be played softly.’", "Sword"), 10),
        WordQ("Which naturalist sailed in the famous ship called Beagle and found the breakthrough island called the ‘Galapagos’?", "Charles Robert Darwin", listOf("Nose and ears", "Compass", "World Wide Web"), 10),
        WordQ("Apart from cheese and tomato, what other two toppings are usually there on a Hawaiian Pizza?", "Pineapple and Ham", listOf("The USA", "Butterfly", "Lightbulb"), 10),
        WordQ("What kind of weapon is a falchion?", "Sword", listOf("Sock", "Komodo dragon", "Mycology"), 10),
        WordQ("What is another word for a ‘lexicon’?", "Dictionary", listOf("52", "Blue", "Pacific Ocean"), 10),
        WordQ("What color is a Himalayan poppy?", "Blue", listOf("Christmas", "Mycology", "Rafflesia"), 10),
        WordQ("In football (soccer), who was nicknamed ‘The Divine Ponytail’?", "Roberto Baggio", listOf("Library", "India", "Water"), 10),
        WordQ("Who wrote the novel ‘1984’?", "George Orwell", listOf("Katherine Hepburn (4 Oscars and 12 nominations)", "23", "Rug"), 10),
        WordQ("How many keys are there on a piano?", "88", listOf("89", "87", "90"), 10),
        WordQ("Who founded the Nobel Prize?", "Alfred Nobel", listOf("Au", "Red, Blue, and Yellow", "Japan"), 10),
        WordQ("In which year was Facebook founded?", "2004", listOf("2005", "2003", "2006"), 10),
        WordQ("How many stars and stripes are there on the US flag?", "50 stars and 13 stripes", listOf("A watch/clock", "Voltaire", "4"), 10),
        WordQ("Where is the World Economic Forum headquartered?", "Switzerland", listOf("Komodo dragon", "4", "Library"), 10),
        WordQ("What is the chemical symbol for gold?", "Au", listOf("Mercury", "O", "Propane and Butane"), 10),
        WordQ("Who founded the theory of relativity?", "Albert Einstein", listOf("Au", "See", "Crust"), 10),
        WordQ("What is the name of the atomic bomb dropped on Hiroshima?", "Little Boy", listOf("A watch/clock", "Silver", "Hydrogen"), 10),
        WordQ("What is sushi wrapped in?", "Seaweed", listOf("Japan", "Puppy", "Marathon"), 10),
        WordQ("What is the name of the device used for measuring speed?", "Speedometer", listOf("Brush", "Mother’s father", "The Taj Mahal"), 10),
        WordQ("What type of waves are sound waves?", "Longitudinal waves", listOf("Greenland shark", "Pizza", "Crust"), 10),
        WordQ("Who discovered electrons?", "J.J. Thomson", listOf("7 days", "3", "Charles Robert Darwin"), 10),
        WordQ("Caterpillars turn into butterflies.", "True", listOf("False", "Pizza", "Harper Lee"), 10),
        WordQ("Adults have a total of 34 teeth.", "False", listOf("True", "Marathon", "Alexander Graham Bell"), 10),
        WordQ("There are 30 days in May.", "False", listOf("True", "Silver", "A watch/clock"), 10),
        WordQ("New York is the capital of America.", "False", listOf("True", "Soccer", "Doc, Grumpy, Happy, Sleepy, Dopey, Bashful and Sneezy."), 10),
        WordQ("Cinderella’s carriage turns into a potato.", "False", listOf("True", "Coal", "See"), 10),
        WordQ("Half of 250 is 125.", "True", listOf("False", "Tadpole", "Pacific Ocean"), 10),
        WordQ("An ostrich’s eye is bigger than its brain.", "True", listOf("False", "Milky Way", "Speedometer"), 10),
        WordQ("A jellyfish is 95% water.", "True", listOf("False", "7", "Nile"), 10),
        WordQ("Plants give us oxygen.", "True", listOf("False", "Italy", "Rainfall"), 10),
        WordQ("Bubble gum contains rubber.", "True", listOf("False", "12 flamingos", "June 5"), 10),
        WordQ("8 o’clock in the evening is written as 8 am.", "False", listOf("True", "Albert Einstein", "Milky Way"), 10),
        WordQ("Bacon was part of the first meal eaten on the Moon.", "True", listOf("False", "Scissors", "Alfred Nobel"), 10),
        WordQ("Spinach originally comes from Iran.", "True", listOf("False", "Sword", "7 days"), 10),
        WordQ("Watermelons are originally from Australia.", "False (originally from West Africa)", listOf("52", "Blue Whale", "24 to 72 hours"), 10),
        WordQ("Black Forest cake has the same colors as the traditional dress of the inhabitants of the Black Forest in Germany.", "True", listOf("False", "Bill Gates", "Mycology"), 10),
        WordQ("There are over 330 different dog breeds in the world.", "True", listOf("False", "Giraffe", "Myology"), 10),
        WordQ("Thunderstorms have particular sound frequencies that can hurt a dog’s ears.", "True", listOf("False", "21", "Tibetan Plateau"), 10),
        WordQ("Adult dogs and adult humans have the same number of teeth.", "False", listOf("True", "Tibet", "Seven"), 10),
        WordQ("The deadliest earthquake of 2017 took place in Iran and Iraq.", "True", listOf("False", "Alfred Nobel", "Library"), 10),
        WordQ("Electrons are larger than molecules.", "False", listOf("True", "24 to 72 hours", "206"), 10),
        WordQ("The national bird of the US is a penguin.", "False", listOf("True", "Tibetan Plateau", "Voltaire"), 10),
        WordQ("A snail can sleep for up to three years.", "True", listOf("False", "Spring, Summer, Autumn, and Winter", "365 days"), 10),
        WordQ("The skull protects the brain.", "True", listOf("False", "Milky Way", "Alice, Through the Looking-Glass by Lewis Carroll"), 10),
        WordQ("The internet was created in the 1990s.", "False", listOf("True", "Bill Gates", "Italy"), 10),
        WordQ("Mark Zuckerberg is the CEO of Tesla.", "False", listOf("True", "Dictionary", "Ostrich"), 10),
        WordQ("The sperm whale is the loudest animal on earth.", "True", listOf("False", "Photosynthesis", "Tibetan Plateau"), 10),
        WordQ("Ants can lift up to 50 times their body weight.", "True", listOf("False", "Fish", "Earrings"), 10),
        WordQ("Claude Monet painted ‘The Scream.’", "False", listOf("True", "Harper Lee", "Tulips"), 10),
        WordQ("The Pyramids of Giza are located in Egypt.", "True", listOf("False", "Postman", "206"), 10),
        WordQ("A ruby is green in color.", "False", listOf("True", "23", "Giraffe"), 10),
        WordQ("World War II ended in 1918.", "False", listOf("True", "Nile", "East"), 10),
        WordQ("The bumblebee bat is the smallest mammal in the world.", "True", listOf("False", "Zebra crossing", "A dance workout"), 10),
        WordQ("South Africa has three capital cities.", "True", listOf("False", "George Orwell", "The Taj Mahal"), 10),
        WordQ("George R.R. Martin is the author of the ‘Game of Thrones’ series.", "True", listOf("False", "Au", "Lion"), 10),
        WordQ("Chocolate is made out of cocoa beans.", "True", listOf("False", "Tulips", "Laptop"), 10),
        WordQ("Which of these is the odd one out: Theater, Ticket, Movie, School?", "School", listOf("Theater", "Ticket", "Movie"), 10),
        WordQ("Which of these is the odd one out: Medicine, Injection, Ointment, Laptop?", "Laptop", listOf("Medicine", "Injection", "Ointment"), 10),
        WordQ("Which of these is the odd one out: Brinjal, Potatoes, Cabbage, Chocolate?", "Chocolate", listOf("Brinjal", "Potatoes", "Cabbage"), 10),
        WordQ("Which of these is the odd one out: Breakfast, Dinner, Lunch, Photograph?", "Photograph", listOf("Breakfast", "Dinner", "Lunch"), 10),
        WordQ("Which of these is the odd one out: Knife, Poison, Gun, Books?", "Books", listOf("Knife", "Poison", "Gun"), 10),
        WordQ("Which of these is the odd one out: Paper, Poster, Book, Rug?", "Rug", listOf("Paper", "Poster", "Book"), 10),
        WordQ("Which of these is the odd one out: Sarah, Rita, Fiona, Matthew?", "Matthew", listOf("Sarah", "Rita", "Fiona"), 10),
        WordQ("Which of these is the odd one out: Earrings, Necklace, Wood, Bracelet?", "Wood", listOf("Earrings", "Necklace", "Bracelet"), 10),
        WordQ("Which of these is the odd one out: Television, History, Science, Math?", "Television", listOf("History", "Science", "Math"), 10),
        WordQ("Which of these is the odd one out: Flower, Tree, Sock, Grass?", "Sock", listOf("Flower", "Tree", "Grass"), 10),
        WordQ("Which of these is the odd one out: Bread, Butter, Cheese, Telephone?", "Telephone", listOf("Bread", "Butter", "Cheese"), 10),
        WordQ("Which of these is the odd one out: Cat, Dog, Rabbit, Flower?", "Flower", listOf("Cat", "Dog", "Rabbit"), 10),
        WordQ("Which of these is the odd one out: Pants, Razor, Skirt, Dress?", "Razor", listOf("Pants", "Skirt", "Dress"), 10),
        WordQ("Which of these is the odd one out: Smartphone, Pen, Pencil, Notebook?", "Smartphone", listOf("Pen", "Pencil", "Notebook"), 10),
        WordQ("Which of these is the odd one out: Bottle, Glass, Cup, Table?", "Table", listOf("Bottle", "Glass", "Cup"), 10),
        WordQ("Which of these is the odd one out: America, Africa, Pacific, Asia?", "Pacific", listOf("America", "Africa", "Asia"), 10),
        WordQ("Which of these is the odd one out: Yellow, Green, Brush, Pink?", "Brush", listOf("Yellow", "Green", "Pink"), 10),
        WordQ("Which of these is the odd one out: Basketball, Tennis, Soccer, Marathon?", "Marathon", listOf("Basketball", "Tennis", "Soccer"), 10),
        WordQ("Which of these is the odd one out: Rose, Tulip, Tomato, Marigold?", "Tomato", listOf("Rose", "Tulip", "Marigold"), 10),
        WordQ("Which of these is the odd one out: Dumplings, Sushi, Fried rice, Pizza?", "Pizza", listOf("Dumplings", "Sushi", "Fried rice"), 10),
        WordQ("Which of these is the odd one out: Bangle, Bracelet, Watch, Earring?", "Earrings", listOf("Bangle", "Bracelet", "Watch"), 10),
        WordQ("Which of these is the odd one out: Everest, Deccan, Kanchenjunga, Alps?", "Deccan", listOf("Everest", "Kanchenjunga", "Alps"), 10),
        WordQ("Which of these is the odd one out: Peanuts, Paprika, Groundnuts, Pine nuts?", "Paprika", listOf("Peanuts", "Groundnuts", "Pine nuts"), 10),
        WordQ("Which of these is the odd one out: Lion, Sheep, Goat, Cow?", "Lion", listOf("Sheep", "Goat", "Cow"), 10),
        WordQ("Which of these is the odd one out: Gold, Silver, Diamond, Coal?", "Coal", listOf("Gold", "Silver", "Diamond"), 10),
        WordQ("How many cards are there in a complete pack of cards?", "52", listOf("20", "32", "40"), 10),
        WordQ("What is the hottest continent on Earth?", "Africa", listOf("Asia", "Europe", "South America"), 10),
        WordQ("What is the most popular sport throughout the world?", "Soccer", listOf("Cricket", "Volleyball", "Football"), 10),
        WordQ("Where does Parmesan cheese come from?", "Italy", listOf("India", "China", "France"), 10),
        WordQ("What type of tree do dates grow on?", "Palm", listOf("Coconut", "Pine", "Birch"), 10),
        WordQ("What is the 15th letter of the English alphabet?", "O", listOf("F", "I", "M"), 10),
        WordQ("How many planets are there in our solar system?", "8", listOf("7", "9", "5"), 10),
        WordQ("Which was the occupation or job of the following famous people: Leonardo da Vinci, Pablo Picasso, Vincent Van Gogh?", "Painter", listOf("Musician", "Carpenter", "Dancers"), 10),
        WordQ("What does WWW stand for?", "World Wide Web", listOf("World Web Warriors", "Wide World Web", "Web Wide World"), 10),
        WordQ("Where is the Eiffel Tower located?", "Paris", listOf("Egypt", "London", "Russia"), 10),
        WordQ("What is the square root of 121?", "11", listOf("23", "45", "3"), 10),
        WordQ("Who wrote ‘To Kill A Mockingbird?’", "Harper Lee", listOf("J.K. Rowling", "Ernest Hemingway", "Mark Twain"), 10),
        WordQ("Which country has the largest population in the world?", "India", listOf("China", "Russia", "Australia"), 10),
        WordQ("What is the capital of Mexico?", "Mexico City", listOf("Guadalajara", "Monterrey", "Aguascalientes"), 10),
        WordQ("What does a Geiger Counter measure?", "Radiation", listOf("Temperature", "Humidity", "Speed"), 10),
        WordQ("What is the study of mushrooms called?", "Mycology", listOf("Anatomy", "Botany", "Ecology"), 10),
        WordQ("How many states of matter are observable in daily life?", "4", listOf("3", "7", "2"), 10),
        WordQ("What metal is the best conductor of electricity?", "Silver", listOf("Gold", "Aluminum", "Magnesium"), 10),
        // Ages 3-5: Very basic
